...
def desplazamiento():
    ...
    resultado = integrar_trapecio(velocidad_funcion, t1, t2)
    resultado_txt = formatear_numero(resultado)

    return {
        "formula": "Desplazamiento = área firmada bajo la velocidad.",
        ...
        "pasos": [
            ...
            "Operación aplicada: se acumula la velocidad con signo.",
            f"Resultado aproximado: {resultado_txt} unidades.",
        ],
        "interpretacion": "El desplazamiento mide cambio neto de posición; las partes con velocidad negativa restan.",
    }
